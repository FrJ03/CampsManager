 ...
 */
public class MonitorDAO implements InterfaceDAO<MonitorBean> {
	/**
	 ...
	 */
	@Override
	public boolean create(MonitorBean object) {
	 ...
	 * @param MonitorBean Monitor con el id que se va a leer de la base de datos.
	 * @return Monitor
	 */
	@Override
	public MonitorBean read(MonitorBean object) {
		...
		try{
			...
			if (rs.next()) {
				...
				object	= new MonitorBean(rs.getInt(1), rs.getString(2), rs.getString(3), rs.getBoolean(4));
	            mon = object;    
	 ...
	 */
	@Override
	public boolean delete(MonitorBean object) {
	 ...
	 */
	public ArrayList<MonitorBean>readAll(){

		BufferedReader reader = null;
		Connector con = new Connector();
		ArrayList<MonitorBean> list = new ArrayList<MonitorBean>();
		...
		try{
			...
			while (rs.next()) {
                ...
                list.add( new MonitorBean(rs.getInt(1), rs.getString(2), rs.getString(3), rs.getBoolean(4)));
	 ...
	 * @return Monitor
	 */
	public MonitorBean read(int id) {
		...
		try{
			...
			if (rs.next()) {
				...
				mon	= new MonitorBean(rs.getInt(1), rs.getString(2), rs.getString(3), rs.getBoolean(4));    
